...
export const customerNotifications: NotificationItem[] = [
  {
    ...
    description: "Lịch hẹn LN-1001 lúc 10:00 ngày 15/07/2026 đã được xác nhận.",
  ...
  },
  {
    ...
    description: "Bạn có lịch hẹn LN-1008 vào 13:00 ngày 18/07/2026.",
...
export const staffNotifications: NotificationItem[] = [
  {
    ...
    description: "Bạn được phân công lịch LN-1009 lúc 16:00 hôm nay.",
  ...
  },
  {
    ...
    description: "Lịch LN-1011 đã được xác nhận cho ngày 20/07/2026.",
